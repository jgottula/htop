...
static void CPUMeter_display(Object* cast, RichString* out) {
   ...
   xSnprintf(buffer, sizeof(buffer), "%.0f%%   ", this->values[1]); buffer[5] = '\0';
   RichString_append(out, CRT_colors[METER_TEXT], "um:");
   RichString_append(out, CRT_colors[CPU_NORMAL], buffer);
   if (this->pl->settings->detailedCPUTime) {
      xSnprintf(buffer, sizeof(buffer), "%.0f%%   ", this->values[2]); buffer[5] = '\0';
      RichString_append(out, CRT_colors[METER_TEXT], "km:");
      RichString_append(out, CRT_colors[CPU_KERNEL], buffer);
      xSnprintf(buffer, sizeof(buffer), "%.0f%%   ", this->values[0]); buffer[5] = '\0';
      RichString_append(out, CRT_colors[METER_TEXT], "ni:");
      RichString_append(out, CRT_colors[CPU_NICE_TEXT], buffer);
      xSnprintf(buffer, sizeof(buffer), "%.0f%%   ", this->values[3]); buffer[5] = '\0';
      RichString_append(out, CRT_colors[METER_TEXT], "ih:");
      RichString_append(out, CRT_colors[CPU_IRQ], buffer);
      xSnprintf(buffer, sizeof(buffer), "%.0f%%   ", this->values[4]); buffer[5] = '\0';
      RichString_append(out, CRT_colors[METER_TEXT], "is:");
      RichString_append(out, CRT_colors[CPU_SOFTIRQ], buffer);
      //if (this->values[5]) {
         xSnprintf(buffer, sizeof(buffer), "%.0f%%   ", this->values[5]); buffer[5] = '\0';
         RichString_append(out, CRT_colors[METER_TEXT], "st:");
         RichString_append(out, CRT_colors[CPU_STEAL], buffer);
      //}
      //if (this->values[6]) {
         xSnprintf(buffer, sizeof(buffer), "%.0f%%   ", this->values[6]); buffer[5] = '\0';
         RichString_append(out, CRT_colors[METER_TEXT], "vm:");
         RichString_append(out, CRT_colors[CPU_GUEST], buffer);
      //}
      xSnprintf(buffer, sizeof(buffer), "%.0f%%   ", this->values[7]); buffer[5] = '\0';
